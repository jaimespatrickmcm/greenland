    ...
    <section id="greenland" className="py-24 bg-[#f3efe8]">
      <div className="max-w-7xl mx-auto px-6">
        ...
        <motion.p
          ...
          className="text-[#4a6838] text-sm font-semibold tracking-widest uppercase mb-4"
        >
          SOBRE O GREENLAND
        </motion.p>
        <motion.h2
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-stretch">
          ...
          >
            ...
            <motion.div variants={fadeInUp} className="relative flex-1">
              ...
              <div className="absolute -bottom-4 -left-4 w-24 h-24 bg-[#8d4e27] rounded-2xl -z-10" />
            </motion.div>
          </motion.div>
          ...
          >
            <motion.div variants={fadeInRight} className="relative">
              ...
              <div className="absolute -top-4 -right-4 w-16 h-16 border-4 border-[#364728] rounded-2xl -z-10" />
            </motion.div>
              ...
              {features.map(({ Icon, title, desc }) => (
                ...
                >
                  <div className="w-10 h-10 flex-shrink-0 bg-[#364728]/10 rounded-full flex items-center justify-center">
                    <Icon className="text-[#364728] text-lg" />
                  </div>
                  <div>
                    <h5 className="font-heading text-sm font-bold text-[#273020]">{title}</h5>
