          ...
          >
            <div className="bg-white rounded-2xl shadow-2xl p-8 md:p-10">
              {submitted ? (
                ...
                >
                  <FaCheckCircle className="text-5xl text-[#364728] mx-auto mb-4" />
                  <h3 className="font-heading text-2xl text-[#273020] mb-2">Mensagem enviada!</h3>
                ...
                <form onSubmit={handleSubmit} className="flex flex-col gap-4">
                  <h3 className="font-heading text-xl text-[#273020] font-bold mb-2">
                    Preencha seus dados
                  </h3>
                  ...
                  <div>
                    <input
                      ...
                      className={`w-full border ${errors.name ? 'border-red-400' : 'border-gray-200'} rounded-xl px-4 py-3 text-sm focus:border-[#364728]`}
                    />
                  ...
                  <div>
                    <label className="flex items-start gap-3 cursor-pointer">
                      <input
                        ...
                        onChange={handleChange}
                        className="mt-0.5 accent-[#364728]"
                      />
                  ...
                  <button
                    type="submit"
                    className="w-full bg-[#8d4e27] hover:bg-[#7a4220] text-white font-bold py-4 rounded-xl text-base transition-all hover:scale-[1.02] shadow-lg"
                  >
                    Quero Saber Mais →
                  </button>
                </form>
